        ...
        <div className="card-container">
          ...
          <div className="linkContainer">
            ...
            <div className="facebook link">
              <box-icon name='facebook' type='logo' color='#0b0b0b' ></box-icon>
            </div>
            <div className="Instagram link">
              <box-icon name='instagram' type='logo' color='#0b0b0b' ></box-icon>
            </div>
            <div className="Github link">
              <box-icon name='github' type='logo' color='#0b0b0b' ></box-icon>
            </div>
          </div>
        </div>
      </div>
